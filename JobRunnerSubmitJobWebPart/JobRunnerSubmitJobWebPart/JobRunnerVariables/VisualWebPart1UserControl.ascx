...
--%>    <table style="width: 93%; height: 437px;">
        ...
        <tr>
            ...
            <td class="style8">
                <asp:TextBox ID="txtPrefix" runat="server" ReadOnly="false" 
                    Width="336px" AutoPostBack="True" ontextchanged="txtPrefix_TextChanged"></asp:TextBox>
                <asp:CheckBox ID="overwriteCheckBox" autopostback="true" runat="server" OnCheckedChanged="overwriteCheckBox_Changed"  />
                overwrite
            </td>
            <td>
        ...
        <!-- <tr>
            <td title="Enter a project description to show next to the XML file name">Project description</td>
            <td> 
                <asp:TextBox ID="txtDesc" runat="server" ReadOnly="false" Width="450px" Rows="3" TextMode="MultiLine" ></asp:TextBox>
            </td>
            <td>
            </td>
        </tr> -->
        ...
        <%--        <tr>
            ...
            <td class="style8">
                <asp:ListBox ID="lstDirs" runat="server" Width="170px" Height="200px" 
        ...
        <tr>
            ...
            <td class="style8">
                <asp:TextBox ID="txtPheno" runat="server" Text="" ReadOnly="false" 
                    Width="531px" AutoPostBack="True" ontextchanged="txtPheno_TextChanged"></asp:TextBox>
            </td>
            <td>
        ...
        <tr>
            <td class="style1" title="1=CHS HM2; 2=CHS_AA; 3=HVH1; 4=CHS1KG; 5=HVH2; 1990=VTE1_1000G; 1991=VTE2_1000G; 1997=CABS_AFA_1kg; 1998=CABS_ASN_1kg; 1999=CHS_EA_1kg; 2000=CHS_AA_1kg ">
                Population type
            </td>
            <td class="style8">
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="tToEventError" runat="server" Text="" ForeColor="Red" Width="255px"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td class="style8">
                <asp:Button ID="DownloadXMLButton" Text="Save JobRunner Variables" Width="206px"
                    runat="server" OnClick="DownloadXML" Style="margin-left: 0px" />
            </td>
            <td>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:Label ID="ErrorGWAS" runat="server" Text="" ForeColor="Red" Width="255px"></asp:Label>
            </td>
        </tr>
    </table>
<%--    </ContentTemplate>
